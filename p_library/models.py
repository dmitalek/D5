...
class Book(models.Model):
    ...
    friend_reader = models.ManyToManyField('p_library.Friend', related_name='book_reader', verbose_name='Читающие друзья', blank=True)
...
class Friend(models.Model):
    ...
    book = models.ForeignKey('p_library.Book', on_delete=models.CASCADE, related_name='book', blank=True, verbose_name='Книги')
